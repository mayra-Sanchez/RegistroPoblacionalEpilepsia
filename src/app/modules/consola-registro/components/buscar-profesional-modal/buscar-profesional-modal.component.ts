...
@Component({
  selector: 'app-buscar-profesional-modal',
  templateUrl: './buscar-profesional-modal.component.html',
  styleUrls: ['./buscar-profesional-modal.component.css']
})
export class BuscarProfesionalModalComponent {
  /**
